...
def running_summary(chatlogs, context_logs, rules, save, client, model, summary, tokens):
    try:
        ...
        memory = [rules, rolls_message, {'role': 'system', 'content': 'This is an overview of the story so far: ' + summary}, {'role': 'user',  'content': action}]
